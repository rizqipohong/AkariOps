...
const copy = {
  en: {
    ...
    brandSubtitle: "AI Field Guide for Retail Systems",
    heroEyebrow: "AI retail operations guide",
    heroTitle: "AI-guided support for scanner, POS, printer, and network failures.",
    heroBody:
      "AkariOps is a browser-based AI troubleshooting experience with a clear operational identity. The assistant is the product engine: it triages, diagnoses, and decides the next action before support handoff.",
    ...
    deploymentEyebrow: "Operational flow",
    deploymentTitle: "From symptom intake to diagnosis, action, and support handoff.",
    deploymentBody:
      "AkariOps captures symptoms, maps likely causes, recommends practical troubleshooting steps, and prepares a clean handoff summary when the case needs human support.",
    characterIdentity: "Character identity",
    mascotTitle: "Akari leads the diagnosis like a calm signal runner.",
    mascotBody:
      "The AI is not framed as a generic chat bubble. It acts like a focused field guide that reads symptoms, chooses the right troubleshooting path, and decides when a human handoff is the smarter move.",
  ...
  id: {
    ...
    navEnglish: "English",
    navIndonesian: "Indonesia",
    brandSubtitle: "Pemandu AI untuk Sistem Retail",
    heroEyebrow: "Panduan AI untuk operasional retail",
    heroTitle: "Dukungan berbasis AI untuk masalah scanner, POS, printer, dan jaringan.",
    heroBody:
      "AkariOps adalah pengalaman troubleshooting berbasis browser dengan identitas operasional yang jelas. Asisten ini menjadi mesin utama produk: melakukan triage, diagnosis, dan menentukan langkah berikutnya sebelum handoff ke support.",
    ...
    deploymentEyebrow: "Alur operasional",
    deploymentTitle: "Dari intake gejala menuju diagnosis, tindakan, dan handoff support.",
    deploymentBody:
      "AkariOps menangkap gejala, memetakan kemungkinan penyebab, merekomendasikan langkah troubleshooting yang praktis, lalu menyiapkan ringkasan handoff saat kasus perlu diteruskan ke support manusia.",
    characterIdentity: "Identitas karakter",
    mascotTitle: "Akari memimpin diagnosis seperti pengarah sinyal yang tenang.",
    mascotBody:
      "AI ini tidak diposisikan sebagai bubble chat generik. Ia bertindak seperti pemandu lapangan yang membaca gejala, memilih jalur troubleshooting yang tepat, dan memutuskan kapan handoff ke manusia lebih masuk akal.",
